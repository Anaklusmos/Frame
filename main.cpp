...
//                quit = true;
        ...
        if( ( cap == true ) && ( fps.get_ticks() < 100 / FRAMES_PER_SECOND ) )
        {
            ...
            SDL_Delay( ( 60 / FRAMES_PER_SECOND ) - fps.get_ticks() );
        }

        if(pos_x>-150&&pos_y<218)
        {
            pos_x=pos_x-17;
            pos_y=pos_y-3;
        }
